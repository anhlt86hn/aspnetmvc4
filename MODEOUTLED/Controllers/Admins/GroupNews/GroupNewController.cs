...
namespace MODEOUTLED.Controllers.Admins.GroupNews
{
    public class GroupNewController : Controller
    {
        ...
        public ActionResult ChangeIndex(int id)
        {
            ...
            var results = "Trạng thái xuất hiện trang chủ đã được thay đổi.";
            return Json(results);
        }

        // AJAX: /GroupNew/ChangePriority
        [HttpPost]
        public ActionResult ChangePriority(int id)
        {
            ...
            var results = "Trạng thái xuất hiện cột bên phải đã được thay đổi.";
            return Json(results);
        }
