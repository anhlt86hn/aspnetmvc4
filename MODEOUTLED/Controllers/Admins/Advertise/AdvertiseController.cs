...
namespace MODEOUTLED.Controllers.Admins.Advertise
{
    public class AdvertiseController : Controller
    {
        ...
        public ActionResult AdvertiseIndex(string sortOrder, string sortName, int? page, string posstionSearch, string sortPos, string getSortNameClass, string getSortOrderClass)
        {
            ...
            sllPos = CreateSSL("Banner trên cùng", "Banner phía trên bên phải", "Banner phía dưới bên phải", "Phía dưới chân trang");
        ...
        {
            ViewBag.sllPossition = CreateSSL("Banner phía trên", "Bên phải phía trên", "Bên phải phía dưới", "Phía dưới chân trang");
        ...
        public ActionResult AdvertiseEdit(int id)
        {
            ...
            ViewBag.sllPossition = CreateSSL("Banner phía trên cùng", "Banner phía trên bên phải", "Banner phía dưới bên phải", "Phía dưới chân trang");
            ViewBag.sllTarget = CreateTarget("_blank", "_seft", "_parient", "_top");
        ...
        public List<SelectListItem> Possition()
        {
            ...
            Possition.Add(new SelectListItem { Value = "0", Text = "Banner trên" });
            Possition.Add(new SelectListItem { Value = "1", Text = "Banner bên phải phía trên" });
            Possition.Add(new SelectListItem { Value = "2", Text = "Banner bên phải phía dưới" });
            Possition.Add(new SelectListItem { Value = "3", Text = "Phía dưới chân trang" });
            return Possition;
        }
        #endregion Possition
        #endregion
        ...
        {
            ViewBag.sllPossition = CreateSSL("Banner trên", "Bên phải phía trên", "Bên phải phái dưới", "Phía dưới chân trang");
            return View();
        }
        #endregion
