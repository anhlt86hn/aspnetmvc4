    ...
    public class OrderController : Controller
    {
            ...
            for (int i = 0; i < pages.Count; i++)
            {
                ...
                if (cus.Count > 0)
                {
                    if (i % 2 == 0)
                    {
                        ...
                        Chuoi += "<a href='/Order/OrderEdit/" + pages[i].Id + "' class='vedit'>Sửa</a>";
                        Chuoi += "<a href='/Order/OrderDelete/" + pages[i].Id + "' onclick='return DeleteConfirm()' class='vdelete'>Xóa</a>";
        ...
        public ActionResult OrderIndexot(int? page, string SoDH)
        {
            ...
            if (!String.IsNullOrEmpty(SoDH))
            {
                ...
                all = all.Where(p => p.Id == oId).OrderByDescending(p => p.Id).ToList();
            }
                ...
                Chuoi+="<table class=\"table table-striped table-bordered dataTable table-hover\" cellspacing=\"0\" id=\"cph_Main_ctl00_ctl00_grvProducts\" style=\"border-collapse: collapse;\">";
                    Chuoi+="<tr>";
                       ...
                       Chuoi+="<th scope=\"col\" style=\"width: 330px;\">Tiền vận chuyển(vnđ)</th>";
                        Chuoi+="<th scope=\"col\" style=\"width: 120px; text-align: center;\" rowspan=\"500\">Tổng tiền(vnđ)<br />";
                    ...
                    for(int j=0; j<bill.Count; j++)
                    {
                        Chuoi+="<tr style=\"background-color: #fff\">";
                            Chuoi+="<td class=\"text-center\" style=\"vertical-align: middle; padding: 2px 0px;\">";
                                ...
                                Chuoi += "<td style=\"vertical-align: middle;\">" + bill[j].Name + "<br />";
        ...
        public ActionResult OrderEdit(int id)
        {
            ...
            if (cus.Count > 0)
            {
                ...
                Chuoicus += "</td>";
                Chuoicus += "<td>" + cus[0].Address + " - Tỉnh/Thành phố " + tinh[0].Name;
                Chuoicus += "</td>";
                Chuoicus += "</tr>";
